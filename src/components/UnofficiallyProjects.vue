<template>
  <div class="grid grid-cols-1 place-items-center gap-12 mx-12 mb-12 mt-6 sm:grid-cols-3 sm:gap-24">
    <a href="https://github.com/aredmondd/perfect-kana" target="_blank">
