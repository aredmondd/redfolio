...
<div class="max-sm:prose-img:my-3 flex sm:flex-row flex-col items-center sm:items-start sm:gap-4">
    <a href="https://open.spotify.com/album/1BKKCq9GMdMahEHhPkde5p"><img src="{petgrief}" alt="" class="w-64 rounded-lg sm:mt-[-15px]"></a>
    <a href="https://a24films.com/films/marty-supreme"><img src="{marty}" alt="" class="w-64 rounded-lg sm:mt-[-90px]"></a>
    <a href="https://open.spotify.com/album/4hsC2oeoSkJiULLob8zM98"><img src="{fs}" alt="" class="w-64 rounded-lg sm:mt-[-60px]"></a>
    <a href="https://gkids.com/films/100-meters/"><img src="{meters}" alt="" class="w-64 rounded-lg sm:mt-[-90px]"></a>
</div>

---

created on {fDate}. this is an entry from the past.
